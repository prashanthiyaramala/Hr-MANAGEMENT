...
let screenWidth = window.innerWidth; // Declare screenWidth as a global variable
    ...
    const Dahead = () => {
        ...
        useEffect(() => {
          // Example logic to calculate remaining time and set last login time
          const calculateRemainingTime = () => {
            // Replace this with your actual calculation logic
            const remainingTimeInSeconds = 3600; // 1 hour in seconds
            const formattedTime = formatTime(remainingTimeInSeconds);
            setRemainingTime(formattedTime);
          };
          const getLastLoginTime = () => {
            // Replace this with your actual logic to get the last login time
            const lastLogin = new Date(); // Example: current date and time
            const formattedTime = formatTime(lastLogin);
  ...
  return (
    ...
    <div onClick={handleFrameClick} style={{
  display: 'flex',
  ...
  <div style={{
    ...
    borderRadius: '5px',
        ...
        src="images\Frame 1000003850.png" alt="Company Logo"/>
...
></div>
        ...
        {showMenu && <Menu handleMenuItemClick={handleMenuItemClick} style={{ position: 'relative', zIndex: 2 }} />}
